...
| [`02_dofbot`](02_dofbot/README.md) | Can the user's robot asset, joints, and camera be made trustworthy before learning? | Goals 1-2 complete; ActionChunk small profile machine-pass/visual-fail, revised visible profile local-pass and remote-pending; Goal 3 planned |
