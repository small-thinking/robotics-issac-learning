...
| [`02_dofbot`](02_dofbot/README.md) | Can the user's robot asset, joints, and camera be made trustworthy before learning? | Goal 1 complete; Goal 2 local harness ready, remote pending; Goal 3 planned |
