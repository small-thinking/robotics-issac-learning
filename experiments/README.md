...
| [`02_dofbot`](02_dofbot/README.md) | Can the user's robot asset, joints, camera, and reaching baseline be made trustworthy before learning? | Goals 1-4 and ActionChunk complete; the unchanged target/torque run proved API and target-buffer propagation while the 4.177° residual remained. [DF-032 requires observation-complete PhysX active joint-force telemetry without treating it as isolated drive torque; Viewer stays blocked](02_dofbot/FAILURE_LEDGER.md) |
