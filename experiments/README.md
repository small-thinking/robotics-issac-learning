...
| [`02_dofbot`](02_dofbot/README.md) | Can the user's robot asset, joints, camera, and reaching baseline be made trustworthy before learning? | Goals 1-4 and ActionChunk complete; lower/farther scene and terminal-finger pose-aware pre-grasp passed local preparation, with Isaac and Viewer pending |
