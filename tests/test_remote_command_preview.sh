...
assert_contains "$dofbot_pregrasp_output" 'goal5_gravity_feed_forward_diagnostic.json'
assert_contains "$dofbot_pregrasp_output" 'gravity_feed_forward_result_2026-07-31.json'
assert_contains "$dofbot_pregrasp_output" '--actuator-config'
assert_contains "$dofbot_pregrasp_output" '--actuator-result'
...
assert_contains "$dofbot_pregrasp_output" '--preflight-contract'
assert_contains "$dofbot_pregrasp_output" '--project-dir'
...
assert_contains "$dofbot_pregrasp_view_output" 'gravity_feed_forward_result_2026-07-31.json'
assert_contains "$dofbot_pregrasp_view_output" '--actuator-config'
assert_contains "$dofbot_pregrasp_view_output" '--actuator-result'
